 ...
 */
final class Version20240402224002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande_materiel (id INT AUTO_INCREMENT NOT NULL, commande_id INT DEFAULT NULL, materiel_id INT DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, INDEX IDX_CEF2A80B82EA2E54 (commande_id), INDEX IDX_CEF2A80B16880AAF (materiel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
